...
exports.sendWhatsAppMessage = exports.fetchGroups = void 0;
 ...
 */
const fetchGroups = async (instanceId, token) => {
    try {
 ...
 */
const sendWhatsAppMessage = async (to, message, instanceId, token, imageUrl) => {
    try {
...
exports.default = {
    fetchGroups: exports.fetchGroups,
